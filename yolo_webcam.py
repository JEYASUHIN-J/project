...
def run_object_detection(args):
    ...
    # Get the indices of the unconnected output layers as a list
    out_layer_indices = net.getUnconnectedOutLayers()

    # Convert the scalar value to a list if needed
    if not isinstance(out_layer_indices, list):
        out_layer_indices = [out_layer_indices]

    # Now you can use the 'out_layer_indices' list to access the appropriate elements
    ln = [net.getLayerNames()[idx[0] - 1] for idx in out_layer_indices]
